...
onAuthStateChanged(auth, async (user) => {
  if (user) {
    ...
    if (authenticatedUser.exists()) {
        ...
        mostrarAreasDaEscolaNoMulticamerasCohafuma();
        verificarVisibilidadeEMostrarSalasDeAulaCohafuma(authenticatedUser);
    } else {
...
//COHAFUMA
function mostrarAreasDaEscolaNoMulticamerasCohafuma() {
...
function verificarVisibilidadeEMostrarSalasDeAulaCohafuma(authenticatedUser) {
  ...
  || authenticatedUser.data().isReforco) || authenticatedUser.data().isAdmin) {
      ...
      <!-- REFORÇO -->
          ...
          <div class="item__container item-reforco">
            <iframe style="width: 90vw; height: 215px; margin: 40px 0 0 0; border-radius: 14px;"
              src="https://acolherservices.iconnecti.com.br/CAMERAS%20COHAFUMA/refor%C3%A7o2.htmlo.html" frameborder="0"
              allowfullscreen></iframe>
